...
//   final ValueChanged onPageTapped;
//   final bool log;
//
//   BannerView(
//     this.banners, {
...
//             widget.disableIndicator ? Container() : this._renderIndicator(),
//           ],
//         ));
//   }
//
...
//                 child: Text("${index}/${_banners.length - 2}",
